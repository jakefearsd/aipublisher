...
class TopicBriefTest {
    ...
    class Construction {
        ...
        void createsWithAllFields() {
            var brief = TopicBrief.builder("Apache Kafka")
                    .targetAudience("developers")
                    .targetWordCount(1500)
                    .requiredSections(List.of("Introduction", "Core Concepts"))
                    .relatedPages(List.of("EventStreaming"))
                    .sourceUrls(List.of("https://kafka.apache.org"))
                    .build();
    ...
    class Immutability {
        ...
        void defensiveCopyIsMade() {
            ...
            var brief = TopicBrief.builder("Topic")
